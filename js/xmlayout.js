...
$.xmlayout = {
	...
	layout : function(root_panel){
		...
		if($.xmlayout.__isNaN(root_panel.height()) || $.xmlayout.__isNaN(root_panel.width()) || root_panel.height() <= 0 || root_panel.width() <= 0)
			throw "XMlayout info: can't get the width and height of panel {selector=" + root_panel.selector + "}";
			...
			init : function(obj){
				...
				try{
					if(data == undefined || data == null)
						throw "XMlayout info: param 'data' in function $.xmlayout init() is null! {selector=" + obj_this.root_panel.selector + "}";

					if(drag_bar_unit != undefined && drag_bar_unit != null){
						if($.xmlayout.__isNaN(drag_bar_unit))
							throw "XMlayout info: param 'drag_bar_unit' in function $.xmlayout init() is not a number! {selector=" + obj_this.root_panel.selector + "}";
						else if(drag_bar_unit < 0)
							throw "XMlayout info: param 'drag_bar_unit' < 0 in function $.xmlayout init()! {selector=" + obj_this.root_panel.selector + "}";
						else
					...
					if(drag_bar_color != undefined && drag_bar_color != null){
						if(typeof drag_bar_color != "string")
							throw "XMlayout info: param 'drag_bar_color' in function $.xmlayout init() is not a string! {selector=" + obj_this.root_panel.selector + "}";
						else
					...
					if(popw != undefined && popw != null){
						if($.xmlayout.__isNaN(popw))
							throw "XMlayout info: param 'popw' in function $.xmlayout init() is not a number! {selector=" + obj_this.root_panel.selector + "}";
						else if(popw < 1)
							throw "XMlayout info: param 'popw' < 1 in function $.xmlayout init()! {selector=" + obj_this.root_panel.selector + "}";
						else
					...
					if(poph != undefined && poph != null){
						if($.xmlayout.__isNaN(poph))
							throw "XMlayout info: param 'poph' in function $.xmlayout init() is not a number! {selector=" + obj_this.root_panel.selector + "}";
						else if(poph < 1)
							throw "XMlayout info: param 'poph' < 1 in function $.xmlayout init()! {selector=" + obj_this.root_panel.selector + "}";
						else
					...
					if(timer != undefined && timer != null){
						if($.xmlayout.__isNaN(timer))
							throw "XMlayout info: param 'timer' in function $.xmlayout init() is not a number! {selector=" + obj_this.root_panel.selector + "}";
						else
					...
					if(dragfix != undefined && dragfix != null){
						if($.xmlayout.__isNaN(dragfix))
							throw "XMlayout info: param 'dragfix' in function $.xmlayout init() is not a number! {selector=" + obj_this.root_panel.selector + "}";
						else
					...
					if(playuseable != undefined && playuseable != null){
						if(typeof playuseable != "boolean")
							throw "XMlayout info: param 'playuseable' in function $.xmlayout init() is not a boolean! {selector=" + obj_this.root_panel.selector + "}";
						else
					...
					if(isborder != undefined && isborder != null){
						if(typeof isborder != "boolean" && !$.isArray(isborder))
							throw "XMlayout info: param 'isborder' in function $.xmlayout init() is not a boolean or object! {selector=" + obj_this.root_panel.selector + "}";
						if($.isArray(isborder) && isborder.length != 4)
							throw "XMlayout info: param 'isborder' in function $.xmlayout init() must be a array of length 4! {selector=" + obj_this.root_panel.selector + "}";
						if($.isArray(isborder))
							$.each(isborder, function(i, v){
								if(typeof v != "boolean"){
									throw "XMlayout info: param 'isborder' in function $.xmlayout init() must be a array of boolean! {selector=" + obj_this.root_panel.selector + "}";
								}
							});
					}
					else{
					...
					if(isradius != undefined && isradius != null){
						if(typeof isradius != "boolean")
							throw "XMlayout info: param 'isradius' in function $.xmlayout init() is not a boolean! {selector=" + obj_this.root_panel.selector + "}";
					...
					if(isdestroy != undefined && isdestroy != null){
						if(typeof isdestroy != "boolean")
							throw "XMlayout info: param 'isdestroy' in function $.xmlayout init() is not a boolean! {selector=" + obj_this.root_panel.selector + "}";
					}
					else{
						isdestroy = true;
					}
					...
					if(isindexshow != undefined && isindexshow != null){
						if(typeof isindexshow != "boolean")
							throw "XMlayout info: param 'isindexshow' in function $.xmlayout init() is not a boolean! {selector=" + obj_this.root_panel.selector + "}";
					...
					throw err + " {selector=" + obj_this.root_panel.selector + "}";
				}
